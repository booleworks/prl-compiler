...
class LogicNGTranspilerEnumNoSlicesTest {
    ...
    fun testModelTranslation() {
        ...
        assertThat(modelTranslation[0].propositions[2].formula()).isEqualTo(f.parse("@ENUM_test#p_p1 | @ENUM_test#p_p2"))
        assertThat(modelTranslation[0].propositions[3].formula()).isEqualTo(f.parse("@ENUM_test#q_r_q1 => @ENUM_test#p_p1"))

        assertThat(modelTranslation[0].propositions[4].formula()).isEqualTo(f.parse("@ENUM_test#a_a1 + @ENUM_test#a_a2 = 1"))
        assertThat(modelTranslation[0].propositions[5].formula()).isEqualTo(f.parse("@ENUM_test#b_b1 + @ENUM_test#b_b2 + @ENUM_test#b_b3 = 1"))
        assertThat(modelTranslation[0].propositions[6].formula()).isEqualTo(f.parse("@ENUM_test#c_c1 + @ENUM_test#c_c2 = 1"))
        assertThat(modelTranslation[0].propositions[7].formula()).isEqualTo(f.parse("@ENUM_test#p_p1 + @ENUM_test#p_p2 + @ENUM_test#p_p3 = 1"))
        assertThat(modelTranslation[0].propositions[8].formula()).isEqualTo(f.parse("@ENUM_test#q_r_q1 + @ENUM_test#q_r_q2 = 1"))
        ...
        assertThat(modelTranslation[0].knownVariables).containsExactlyInAnyOrderElementsOf(
            f.variables(
                ...
                "@ENUM_test#p_p1", "@ENUM_test#p_p2", "@ENUM_test#p_p3",
                "@ENUM_test#q_r_q1", "@ENUM_test#q_r_q2",
            )
        )
        assertThat(modelTranslation[0].enumMapping).hasSize(5)
        assertThat(modelTranslation[0].info.getFeatureAndValue(f.variable("@ENUM_test#p_p3"))).isEqualTo(Pair("test.p", "p3"))
    }
}
