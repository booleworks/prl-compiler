...
class SliceComputationTest {
    ...
    fun testOnePropertyNoFilter() {
        ...
        assertThat(slices1).containsExactlyInAnyOrder(Slice.of(BooleanProperty("b2", true)), Slice.of(BooleanProperty("b2", false)))
        assertThat(slices2).containsExactlyInAnyOrder(Slice.of(BooleanProperty("b3", true)), Slice.of(BooleanProperty("b3", false)))
    }
    ...
    fun testTwoPropertiesWithFilter() {
        val slices1 = computeAllSlices(listOf(BooleanSliceSelection("b2", BooleanRange.list(true), SPLIT)), listOf(b2, d1))
        ...
        assertThat(slices2).containsExactlyInAnyOrder(
            Slice.of(mapOf(Pair(DateProperty("d1", date1), SPLIT))), Slice.of(mapOf(Pair(DateProperty("d1", date3), SPLIT)))
        )
    }
    ...
    fun testThreePropertiesNoFilter() {
        ...
        assertThat(slices1).containsExactlyInAnyOrder(
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 1), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 2), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 3), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 4), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 11), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 13), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 14), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 15), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 22), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 1), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 2), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 3), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 4), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 11), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 13), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 14), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 15), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 22), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 1), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 2), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 3), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 4), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 11), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 13), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 14), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 15), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), ANY), Pair(IntProperty("i1", 22), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 1), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 2), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 3), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 4), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 11), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 13), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 14), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 15), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date3), ANY), Pair(IntProperty("i1", 22), ANY))),
        )
    }
    ...
    fun testThreePropertiesWithFilter() {
        ...
        assertThat(slices1).containsExactlyInAnyOrder(
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 11), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 13), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 14), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", true), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 15), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 11), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 13), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 14), ANY))),
            Slice.of(mapOf(Pair(BooleanProperty("b2", false), ANY), Pair(DateProperty("d1", date1), SPLIT), Pair(IntProperty("i1", 15), ANY))),
        )
    }
    ...
    fun testComputeSliceSetsSingleProperty() {
        ...
        assertThat(sliceSets[5].slices).containsExactly(Slice.of(IntProperty("i1", 13)), Slice.of(IntProperty("i1", 15)))
        assertThat(sliceSets[5].definitions).containsExactly(defs[0], defs[1], defs[2], defs[3])
        assertThat(sliceSets[5].rules).isEmpty()

        assertThat(sliceSets[6].slices).containsExactly(Slice.of(IntProperty("i1", 14)), Slice.of(IntProperty("i1", 22)))
