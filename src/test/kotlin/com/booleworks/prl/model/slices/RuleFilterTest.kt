...
class RuleFilterTest {
    ...
    fun testRuleFilterActive() {
        ...
        assertThat(filtered1).containsExactly(rules[1], rules[2], rules[3], rules[4], rules[5], rules[6], rules[7], rules[8])
        assertThat(filtered2).containsExactly(rules[0], rules[2], rules[3], rules[4], rules[5], rules[6], rules[7], rules[8])
        assertThat(filtered3).containsExactly(rules[0], rules[1], rules[2], rules[3], rules[4], rules[5], rules[6], rules[7], rules[8])
    }
    ...
    fun testRuleFilterVersion() {
        ...
        assertThat(filtered1).containsExactly(rules[0], rules[1], rules[2], rules[4], rules[5], rules[6], rules[7], rules[8])
        assertThat(filtered2).containsExactly(rules[0], rules[1], rules[3], rules[4], rules[5], rules[6], rules[7], rules[8])
        assertThat(filtered3).containsExactly(rules[0], rules[1], rules[2], rules[3], rules[4], rules[5], rules[6], rules[7], rules[8])
        assertThat(filtered4).containsExactly(rules[0], rules[1], rules[2], rules[3], rules[4], rules[5], rules[6], rules[7])
    }
