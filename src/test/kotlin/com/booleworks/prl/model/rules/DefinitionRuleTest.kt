...
class DefinitionRuleTest {
    ...
    fun testDefaultsConstructor() {
        val rule = DefinitionRule(feature, constraint, DEFAULT_MODULE)
        ...
        assertThat(rule.toString(DEFAULT_MODULE)).isEqualTo("rule f is a & b")
    ...
    fun testFullConstructor() {
        val rule = DefinitionRule(feature, constraint, DEFAULT_MODULE, "id string", "text text", properties)
        assertThat(rule.feature).isEqualTo(feature)
        assertThat(rule.definition).isEqualTo(constraint)
    ...
    fun testEquals() {
        val rule = DefinitionRule(feature, constraint, DEFAULT_MODULE, "id string", "text text", properties)
        val rule1 = DefinitionRule(feature, constraint, DEFAULT_MODULE, "id string", "text text", properties)
        val rule2 = DefinitionRule(feature, constraint, DEFAULT_MODULE, "id string 2", "text text", properties)
        val rule3 = DefinitionRule(feature, constraint, DEFAULT_MODULE, "id string", "text text 2", properties)
        val rule4 =
            DefinitionRule(feature, constraint, DEFAULT_MODULE, "id string", "text text", mapOf(Pair("p1", EnumProperty("p1", EnumRange.list("text 1")))))
        val rule5 = DefinitionRule(boolFt("f2"), constraint, DEFAULT_MODULE, "id string", "text text", properties)
        val rule6 = DefinitionRule(feature, TRUE, DEFAULT_MODULE, "id string", "text text", properties)
    ...
    @Test
    fun testFeatures() {
        val rule = DefinitionRule(boolFt("f1"), and, DEFAULT_MODULE)
    ...
    fun testEvaluate() {
        ...
        val rule = DefinitionRule(feature, and, DEFAULT_MODULE)
    ...
    fun testRestrict() {
        ...
        assertThat(rule.restrict(ass1)).isEqualTo(ConstraintRule(constraint, DEFAULT_MODULE))
        assertThat(rule.restrict(ass2)).isEqualTo(ConstraintRule(not(constraint), DEFAULT_MODULE))
        assertThat(rule.restrict(ass3)).isEqualTo(DefinitionRule(feature, boolFt("b"), DEFAULT_MODULE))
        assertThat(rule.restrict(ass4)).isEqualTo(ConstraintRule(boolFt("f"), DEFAULT_MODULE))
        assertThat(rule.restrict(ass5)).isEqualTo(ConstraintRule(not(boolFt("f")), DEFAULT_MODULE))
    }

    @Test
    fun testSyntacticSimplify() {
        val rule1 = DefinitionRule(feature, feature, DEFAULT_MODULE)
        val rule2 = DefinitionRule(feature, or(boolFt("b"), boolFt("a"), TRUE), DEFAULT_MODULE)
        val rule3 = DefinitionRule(feature, FALSE, DEFAULT_MODULE)
        assertThat(rule1.syntacticSimplify()).isEqualTo(ConstraintRule(TRUE, DEFAULT_MODULE))
        assertThat(rule2.syntacticSimplify()).isEqualTo(ConstraintRule(feature, DEFAULT_MODULE))
    ...
    fun testRenaming() {
        ...
        val rule = DefinitionRule(feature, definition, DEFAULT_MODULE)
